...
import 'package:milkdistributionflutter/seller/route_list.dart';
...
class AddrouteState extends State<AddRoute> {
  ...
  Future AddRouteData() async{
    ...
    var response = await http.post(Uri.parse(_myServices.myUrl! + "Route/AddRoute"),
        body: JsonBody,
        headers: {"Accept": "application/json"});
