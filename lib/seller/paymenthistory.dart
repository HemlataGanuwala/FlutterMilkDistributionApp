...
class PaymentHistory extends StatefulWidget {
  ...
  PaymentHistory(this.custid, this.custnm, this.mobile);
  @override
  State<StatefulWidget> createState() {
    return PaymentHistoryState(custid, custnm, mobile);
  }
}

class PaymentHistoryState extends State<PaymentHistory> {
  String custid, custnm, mobile;
  PaymentHistoryState(this.custid, this.custnm, this.mobile);
