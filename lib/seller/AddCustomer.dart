...
class _AddCustomerState extends State<AddCustomer>{
  ...
  Future AddRateData() async{
    Map<String, String> JsonBody = {
      'Cowrate':_cowrate.text,
      'Buffallorate':_buffrate.text,
      'CompanyId': _myServices.myCompanyId!,
    };
    var response = await http.post(Uri.parse(_myServices.myUrl! + "Rate/AddMilkRate"),
        body: JsonBody,
        headers: {"Accept": "application/json"});
    ...
    if(data == 1)
    {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Milk rate added successfully"),
        ...
        children: <Widget>[
          ...
          InkWell(
            ...
            child: Container(
              child: Row(
                children: <Widget>[
                  Icon(Icons.add_circle, size: 28.0,color: Color(0xFF2B2B81),),
                  Text("Milk Rate",style: GoogleFonts.adamina(color: Colors.red, fontWeight: FontWeight.bold),),
                ],
              ),
            ),
          ),
  ...
  Future AddCustomerData() async{
    ...
    var response = await http.post(Uri.parse(_myServices.myUrl! + "Customer/AddCustomer"),
        body: JsonBody,
        headers: {"Accept": "application/json"});
    var data = jsonDecode(response.body)['Status'];
    var message = jsonDecode(response.body)['Message'];
                          ...
                          Padding(
                            ...
                            child: ButtonTheme(
                              ...
                              child: TextButton(
                                ...
                                child: Text("SUBMIT",
                                    style: GoogleFonts.adamina(fontSize: 16.0)),),
                            ),
                          ),
                        ],
                      ),
     ...
     showDialog(
      ...
      builder: (ctx) => AlertDialog(
        title: Container(
            ...
            child: Text("Add Milk Rate", style: GoogleFonts.adamina(fontSize: 18.0, color: Color(0xFF2B2B81),
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Container(
                            width: 120.0,
                            child: Text("Cow Milk Rate", style: GoogleFonts.adamina(fontSize: 14.0,color: Color(0xFF2B2B81)),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Container(
                            width: 30.0,
                            child: Text("1", style: GoogleFonts.adamina(fontSize: 14.0,color: Color(0xFF2B2B81)),)),
                      ),
                      Expanded(child: Container(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left: 8.0),
                            child: TextField(controller: _cowrate,style: GoogleFonts.adamina(fontSize: 14.0, color: Color(0xFF2B2B81),),
                  ...
                  child: Row(
                    children: <Widget>[
                      Padding(
                        ...
                        child: Container(
                          width: 120.0,
                            child: Text("Buffallo Milk \nRate", style: GoogleFonts.adamina(fontSize: 14.0,color: Color(0xFF2B2B81)),)),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(8.0),
                        child: Container(
                      ...
                      Expanded(child: Container(
                        width: 200,
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(left:8.0),
                            child: TextField(controller: _buffrate,style: GoogleFonts.adamina(fontSize: 14.0, color: Color(0xFF2B2B81),),
                              decoration: InputDecoration(
                                border: InputBorder.none,
                              ),
                              keyboardType: TextInputType.number,),
