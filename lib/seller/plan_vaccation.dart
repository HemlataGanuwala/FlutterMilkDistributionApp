...
class PlanVaccation extends StatefulWidget{

int plancustid;
PlanVaccation(this.plancustid);

  @override
  State<StatefulWidget> createState() {
    return PlanVaccationState(plancustid);
  }

}

class PlanVaccationState extends State<PlanVaccation> {
  int custid;
  PlanVaccationState(this.custid);
