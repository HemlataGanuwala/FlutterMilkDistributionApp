...
class MonthlyCustomerList extends StatefulWidget{
  @override
  MonthlyCustomerListState createState() => MonthlyCustomerListState();
}

class MonthlyCustomerListState extends State<MonthlyCustomerList> {
  ...
  Future<List<CustomerModel>> getCustomerData() async{
    ...
    var response = await http.post(Uri.parse(_myServices.myUrl + "Customer/GetActiveCustomer"),
        body: JsonBody,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Center(child: Text("Monthly Customer List")),
                          ...
                          return InkWell(
                            onTap: (){
                              Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => MonthlyReport(searchList[contextIndex].Id,searchList[contextIndex].CustomerName)))
                                .then((value) => setState(() {
                                  customerfuture = getCustomerData();
                                              customerfuture.then((value){
                                                setState(() {
